# nix run github:nix-community/plasma-manager
{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      plasmashell."activate application launcher" = ["Meta+Control" "Alt+F1"];
      ...
      "services/Alacritty.desktop"._launch = "Meta+Y";
      "services/code.desktop".new-empty-window = "Meta+C";
    ...
    configFile = {
      ...
      dolphinrc.DetailsMode.RightPadding = 40;
      dolphinrc.ExtractDialog."2 screens: Height" = 1080;
      dolphinrc.ExtractDialog."2 screens: Width" = 2225;
      dolphinrc.ExtractDialog."DirHistory[$e]" = "$HOME/.local/share/PrismLauncher/instances/1.12.2 Ornithe Test/minecraft/saves/,$HOME/.local/share/PrismLauncher/instances/1.12.2 Carpet Server/ carpetserver/sessions/,$HOME/.local/share/PrismLauncher/instances/1.15 masa fork/minecraft/saves/,$HOME/.local/share/PrismLauncher/instances/1.15.2/minecraft/saves/World Copy/,$HOME/.local/share/PrismLauncher/instances/1.15.2/minecraft/saves/WorldPreWERUN/,/tmp/rrrr/,/tmp/www/,/tmp/,$HOME/.local/share/PrismLauncher/instances/1.0/minecraft/saves/New Folder/,$HOME/.local/share/PrismLauncher/instances/1.0/minecraft/saves/";
      ...
      dolphinrc.General.RenameInline = false;
      ...
      krunnerrc."Plugins/Favorites".plugins = "krunner_services,krunner_systemsettings,calculator";
      ...
      kwinrc."Tiling/98fb63ae-4834-402d-99be-bb4e9adb7b8b/92e7207d-7523-4962-a222-ada7345a2bb8".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc."Tiling/98fb63ae-4834-402d-99be-bb4e9adb7b8b/b5add7e7-1013-4844-b8de-198af1d18034".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc."Tiling/a109daa5-e1d1-5fba-95e3-edc4c6bd0aa8".tiles = "{\"layoutDirection\":\"vertical\",\"tiles\":[]}";
      kwinrc."Tiling/d50fe48e-64a3-4fe3-bee2-2a49dc8aed52/92e7207d-7523-4962-a222-ada7345a2bb8".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc."Tiling/d50fe48e-64a3-4fe3-bee2-2a49dc8aed52/b5add7e7-1013-4844-b8de-198af1d18034".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc."Tiling/e2d77d47-79d7-47b7-ad53-fe949c12cb67/92e7207d-7523-4962-a222-ada7345a2bb8".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc."Tiling/e2d77d47-79d7-47b7-ad53-fe949c12cb67/b5add7e7-1013-4844-b8de-198af1d18034".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      spectaclerc.ImageSave.lastImageSaveAsLocation = "file:///home/xiej/Pictures/Screenshots/Screenshot_2025-11-22_19-09-10.png";
      spectaclerc.ImageSave.lastImageSaveLocation = "file:///home/xiej/Documents/vscode-pink-candy/img/Screenshot_2026-03-27_19-34-53.png";
      ...
      yakuakerc.Animation.Frames = 0;
      yakuakerc.Appearance.BackgroundColor = "12,12,20";
      yakuakerc.Behavior.OpenAfterStart = true;
      yakuakerc.Dialogs.FirstRun = false;
      yakuakerc.Window.DynamicTabTitles = true;
      yakuakerc.Window.Height = 88;
      yakuakerc.Window.Position = 51;
    };
    dataFile = {
      "kate/anonymous.katesession"."Document 0".URL = "file:///home/xiej/OneDrive/Documents/Money/Credit Card/PayPal MC/February 2026-transactions.csv";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-2-Splitter = 3747;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-3-Splitter = 1387;
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0".CursorColumn = 12;
